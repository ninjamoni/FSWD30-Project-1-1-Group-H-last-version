...
var current_year = today.getFullYear();
 ...
 var content = [ new News ("Latest Technology", "BiM Factory", today, "../lightcity.png", "blogpost.html", "Lorem ipsum sit amet, consectetur adipiscing elit. Donec nec mauris sit amet mi posuere imperdiet. Sed congue velit placerat sapien gravida sagittis. Phasellus in convallis urna, sit amet sollicitudin augue."),
 				 new News ("New Technology", "nerdy guy", today, "../digitalcity.jpg", "blabla", "This content here could be really amazing. Just provide us with some text."),
 				 new News ("BlaBla title", "CodeFactory", today, "../laptop.jpg", "blabla", "New chance for all of us!"),
 				 new News ("Random stuff", "Cool guy", today, "../bluecity.jpg", "blabla", "lorem ipsum text in here"),
 				 new News ("Latest Technology", "Alien", today, "../data.jpg", "blabla", "ZDAJ PA SEM TUKAJ SAMO DA VIDIM CE DELA TOLE"),
 				 new News ("Latest Technology", "Random Person", today, "../work.jpg", "blabla", "My name is random text, out of ideas"),
 				 new News ("Latest Technology", "Not so cool guy", today, "../blueandwhite.jpg", "blabla", "Imagine ome amazing tet here.")
